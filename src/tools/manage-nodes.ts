      ...
      nodes: {
        ...
        items: {
          ...
          properties: {
            ...
            data_source: { type: "string", description: "Optional URL or citation for the data source of this node. If provided, a 'DataSource' node and 'DATA_SOURCE' relationship will be automatically created." },
            relationships: {
              type: "array",
              items: {
                type: "object",
